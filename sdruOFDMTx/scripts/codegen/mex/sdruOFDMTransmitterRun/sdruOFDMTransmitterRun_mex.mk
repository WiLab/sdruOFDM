START_DIR = /home/traviscollins/git/USRP_MATLAB/sdruOFDMTx/scripts

MATLAB_ROOT = /opt/MATLAB/R2013a
MAKEFILE = sdruOFDMTransmitterRun_mex.mk

include sdruOFDMTransmitterRun_mex.mki
...
MEX_FILE_NAME_WO_EXT = sdruOFDMTransmitterRun_mex
...
SYS_INCLUDE += -I "$(START_DIR)/codegen/mex/sdruOFDMTransmitterRun"
...
%.$(OBJEXT) : $(START_DIR)/codegen/mex/sdruOFDMTransmitterRun/%.c
	$(CC) $(CCFLAGS) "$<"
...
%.$(OBJEXT) : $(START_DIR)/codegen/mex/sdruOFDMTransmitterRun/%.cu
	$(CC) $(CCFLAGS) "$<"
...
%.$(OBJEXT) : $(START_DIR)/codegen/mex/sdruOFDMTransmitterRun/%.cpp
	$(CXX) $(CPPFLAGS) "$<"
