...
static emlrtRSInfo od_emlrtRSI = { 31, "xcorr",
  "/opt/MATLAB/R2013a/toolbox/signal/eml/xcorr.m" };

static emlrtRSInfo pd_emlrtRSI = { 94, "xcorr",
  "/opt/MATLAB/R2013a/toolbox/signal/eml/xcorr.m" };

static emlrtBCInfo o_emlrtBCI = { 1, 16, 181, 35, "", "xcorr",
  "/opt/MATLAB/R2013a/toolbox/signal/eml/xcorr.m", 0 };

static emlrtBCInfo p_emlrtBCI = { 1, 1231, 181, 48, "", "xcorr",
  "/opt/MATLAB/R2013a/toolbox/signal/eml/xcorr.m", 0 };
...
void b_xcorr(const real_T arg1[1231], real_T C[2461])
{
  ...
  for (i = 0; i < 2461; i++) {
    ...
    i14 = (int32_T)muDoubleScalarMin((1.0 + (real_T)i) - 1215.0, 1231.0) -
      jstart;
    for (j = 0; j <= i14; j++) {
      b_j = jstart + j;
      i15 = (b_j - i) + 1230;
      emlrtDynamicBoundsCheckFastR2012b(i15, 1, 16, &o_emlrtBCI,
        emlrtRootTLSGlobal);
      emlrtDynamicBoundsCheckFastR2012b(b_j, 1, 1231, &p_emlrtBCI,
        emlrtRootTLSGlobal);
      s += arg1[b_j - 1];
    }
...
void xcorr(const creal_T arg1[1231], const creal_T arg2[16], creal_T C[2461])
{
  ...
  for (i = 0; i < 2461; i++) {
    ...
    i12 = (int32_T)muDoubleScalarMin((1.0 + (real_T)i) - 1215.0, 1231.0) -
      jstart;
    for (j = 0; j <= i12; j++) {
      b_j = (jstart + j) - 1;
      i13 = (b_j - i) + 1231;
      emlrtDynamicBoundsCheckFastR2012b(i13, 1, 16, &o_emlrtBCI,
        emlrtRootTLSGlobal);
      i13 = b_j + 1;
      emlrtDynamicBoundsCheckFastR2012b(i13, 1, 1231, &p_emlrtBCI,
        emlrtRootTLSGlobal);
