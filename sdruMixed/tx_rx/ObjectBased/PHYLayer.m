classdef PHYLayer < handle
    ...
    methods
        ...
        function obj = PHYLayer
            ...
            obj.offsetCompensationValue = -77148;% Get from calibration
            %obj.offsetCompensationValue = 71289;% Get from calibration
            ...
            % Soft decisions
            obj.messageBits = zeros(obj.numFrames,obj.rx.messageCharacters*7+3);%3 for CRC
        ...
        function [recoveredMessage] = Receive(obj)
            ...
            while obj.estimate.numProcessed < obj.numFrames
                ...
                if FrameFound
                    ...
                    obj.messageBits(obj.estimate.numProcessed,:) = RHard;
        ...
        % Send Messages
        function Transmit(obj,inputPayloadMessage,numFramesToTx)
        ...
        function occupied = Sense(obj)
            ...
            if obj.DebugFlag;fprintf('PHY| Sensing\n');end;
