START_DIR = /home/traviscollins/git/USRP_MATLAB/sdruOFDMRx/scripts

MATLAB_ROOT = /opt/MATLAB/R2013a
MAKEFILE = receiveOFDM80211a_sdru_mex.mk

include receiveOFDM80211a_sdru_mex.mki
...
MEX_FILE_NAME_WO_EXT = receiveOFDM80211a_sdru_mex
...
SYS_INCLUDE += -I "$(START_DIR)/codegen/mex/receiveOFDM80211a_sdru"
...
%.$(OBJEXT) : $(START_DIR)/codegen/mex/receiveOFDM80211a_sdru/%.c
	$(CC) $(CCFLAGS) "$<"
...
%.$(OBJEXT) : $(START_DIR)/codegen/mex/receiveOFDM80211a_sdru/%.cu
	$(CC) $(CCFLAGS) "$<"
...
%.$(OBJEXT) : $(START_DIR)/codegen/mex/receiveOFDM80211a_sdru/%.cpp
	$(CXX) $(CPPFLAGS) "$<"
