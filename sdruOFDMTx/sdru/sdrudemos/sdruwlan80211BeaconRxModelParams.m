...
switch mode
  case 'init'
    ...
    % Model name
    [chanNum, agcLoopGain, agcMaxGain, corrThreshold] =  ...
    ...
    try 
      validateattributes(agcLoopGain, {'numeric'}, ...
        {'real','positive','scalar', '<', 1}, ...
        'sdruwlan80211BeaconRxModelParams', '''AGC loop gain''');
    catch e
    ...
    sampsPerChip = 2;
    p80211 = sdruwlan80211BeaconRxInit(agcLoopGain, agcMaxGain, ...
